  ...
  <div class="min-h-screen">
    <UContainer class="py-12">
      <div class="text-center mb-12">
        <UBadge color="primary" size="lg" class="mb-4">Nouveautés</UBadge>
      ...
      <div v-else class="text-center py-12">
        <p class="text-gray-600 dark:text-gray-400">Aucun nouveau produit pour le moment</p>
      </div>
    </UContainer>
  </div>
</template>
